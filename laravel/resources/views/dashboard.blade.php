...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="ista-shell ista-display-sans text-stone-800">
        <div class="relative min-h-screen overflow-hidden" style="background-image: radial-gradient(circle at 0 0, rgba(245, 158, 11, 0.08) 0%, rgba(245, 158, 11, 0) 30%), radial-gradient(circle at 100% 100%, rgba(76, 5, 25, 0.08) 0%, rgba(76, 5, 25, 0) 35%), url('/images/ista/dashboard-grid.png'); background-size: auto, auto, 8px 8px;">
            ...
            <div class="pointer-events-none absolute inset-0 overflow-hidden opacity-40">
                ...
                <div class="absolute bottom-10 right-1/4 h-40 w-40 rounded-full border-[20px] border-[#8b0836]/5"></div>
                ...
                <svg class="absolute bottom-12 left-1/3 h-32 w-32 -rotate-12 text-[#8b0836]/5" fill="currentColor" viewBox="0 0 24 24">
            ...
            <main class="relative z-10 mx-auto flex min-h-[calc(100vh-136px)] w-full max-w-7xl items-center px-5 pb-20 pt-16 sm:px-10">
                <section class="w-full text-center">
                    ...
                    <h1 class="ista-hero-title mt-8 text-stone-900">Tanya <strong><span class="text-[#8b0836]">ISTA</span> <span class="font-light italic text-[#d4af37]">AI</span></strong></h1>
                    ...
                    <div class="mx-auto mt-10 grid max-w-sm gap-3">
                        @auth
                        <a href="{{ route('chat') }}" class="rounded-2xl border border-stone-200 bg-white/80 px-4 py-3 text-sm font-semibold text-stone-700 transition hover:border-[#8b0836]/30 hover:text-[#8b0836]">Buka Chat</a>
                        @else
                        <a href="{{ route('chat') }}" class="rounded-2xl border border-stone-200 bg-white/80 px-4 py-3 text-sm font-semibold text-stone-700 transition hover:border-[#8b0836]/30 hover:text-[#8b0836]">Buka Chat</a>
                        @endauth
                    </div>
