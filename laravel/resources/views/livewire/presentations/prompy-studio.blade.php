                ...
                @if($activePackage)
                    <div class="memo-config-panel">
                        ...
                        <div class="memo-config-section bg-stone-50/65 dark:bg-gray-950/20">
                            ...
                            <p class="mt-2 whitespace-pre-wrap rounded-lg bg-white px-3 py-3 text-[12.5px] leading-relaxed text-stone-700 dark:bg-gray-900 dark:text-gray-300">{{ $activePackage['main_prompt'] ?? '' }}</p>
                        </div>
                                ...
                                <div class="space-y-2">
                                    @foreach($activePackage['variants'] as $vi => $variant)
                                        <div class="flex items-start gap-2">
                                            <p class="flex-1 whitespace-pre-wrap rounded-lg bg-stone-50 px-3 py-2 text-[12.5px] leading-relaxed text-stone-600 dark:bg-gray-950 dark:text-gray-400">{{ $variant }}</p>
                        ...
                        @if(($activePackage['negative_prompt'] ?? '') !== '')
                            <div class="memo-config-section bg-stone-50/50 dark:bg-gray-950/20">
                                ...
                                <p class="mt-2 whitespace-pre-wrap rounded-lg bg-white px-3 py-2 text-[12.5px] leading-relaxed text-stone-600 dark:bg-gray-900 dark:text-gray-400">{{ $activePackage['negative_prompt'] }}</p>
                            </div>
                        @endif
