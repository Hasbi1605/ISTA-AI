...
<head>
    ...
    <title>Verifikasi 2FA · ISTA AI</title>
    ...
    <div class="relative flex min-h-screen w-full items-center justify-center overflow-hidden px-4 py-10">
        ...
        <main class="relative w-full max-w-md">
            ...
            <section class="rounded-2xl border border-stone-200 bg-white/95 p-6 shadow-sm backdrop-blur dark:border-gray-800 dark:bg-gray-900/80 sm:p-8">
                ...
                <form method="POST" action="{{ route('admin.2fa.verify') }}" class="space-y-4" novalidate>
                    @csrf
                    <div>
                        <label for="code" class="block text-[11px] font-semibold uppercase tracking-[0.16em] text-stone-500 dark:text-gray-400">Kode verifikasi</label>
                        <input id="code"
                               type="text"
                               name="code"
                               inputmode="text"
