...
class PromptStudioService
{
    ...
    public function generate(User $user, array $input): GeneratedPrompt
    {
        ...
        try {
            $package = $this->requestPackage($idea, $platform, $promptType, $contextNotes);
        } catch (Throwable $e) {
     ...
     */
    protected function requestPackage(string $idea, string $platform, string $promptType, string $contextNotes): array
    {
        $payload = [
            'idea' => $idea,
            'platform' => $platform,
