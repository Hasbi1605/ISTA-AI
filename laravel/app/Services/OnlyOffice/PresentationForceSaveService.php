...
/**
 * Force-save OnlyOffice Slides untuk presentasi (#226), mirror dari
 * MemoForceSaveService di namespace presentasi. Memicu command `forcesave`
 * ke Document Server lalu menunggu callback status 6 menyimpan PPTX terbaru.
 */
    ...
    public function forceSave(Presentation $presentation, ?PresentationVersion $version = null): array
    {
        ...
        if (! $response?->successful()) {
            ...
            throw new ForceSaveException(
                'OnlyOffice belum bisa menyimpan perubahan editor presentasi.',
        ...
        if ($error !== 0) {
            ...
            throw new ForceSaveException(
                'OnlyOffice belum siap menyimpan presentasi. Kode error: '.$error,
    ...
    protected function waitUntilSaved(string $cacheKey, int $waitSeconds): string
    {
        ...
        do {
            ...
            if ($status === 'failed') {
                ...
                throw new ForceSaveException(
                    'OnlyOffice gagal menyimpan perubahan editor presentasi.',
                    Response::HTTP_CONFLICT,
                );
            }
        ...
        throw new ForceSaveException(
            'Perubahan editor presentasi belum selesai tersimpan. Coba lagi sebentar.',
