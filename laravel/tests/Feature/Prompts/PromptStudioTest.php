...
class PromptStudioTest extends TestCase
{
    ...
    public function test_start_new_prompt_shows_empty_result_panel_even_with_history(): void
    {
        ...
        Livewire::actingAs($user)
            ...
            ->assertSee('Pilih atau seret dokumen acuan')
    ...
    public function test_reference_images_can_be_reordered_via_drag(): void
    {
        ...
        Livewire::actingAs($user)
            ...
            ->assertSee('dropReferenceImage($event)', false)
            ->assertSee('dropReferenceDocument($event)', false)
            ->assertSee('dropPrompyConfigPanel($event)', false)
            ->assertSee('dropRevisionComposer(event)', false)
            ->assertSee('window.istaMergeFilesWithCap?.(', false)
            ->assertSee('Pilih atau seret dokumen acuan', false)
            ->assertSee('Seret gambar (maks. 5) atau dokumen acuan (maks. 3)', false)
    ...
    public function test_reference_document_upload_sync_appends_like_reference_images(): void
    {
        ...
        Livewire::actingAs($user)
            ...
            ->assertSee('window.istaMergeFilesWithCap?.(', false)
            ->assertSee('setReferenceDocumentFiles(fileList)', false)
            ->assertSee('setRevisionReferenceDocumentFiles(fileList)', false)
