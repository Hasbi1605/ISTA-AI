...
1. [00-HANDOVER.md](00-HANDOVER.md) - ringkasan sistem, status, risiko, dan checklist serah-terima.
...
8. [07-SERVER-DOMAIN-MIGRATION.md](07-SERVER-DOMAIN-MIGRATION.md) - checklist pindah server/domain.
