...
- **Presentations/** `PresentationGenerationService` (createAndDispatch + render PPTX via python `/api/presentations/generate`, outline deterministik dari konfigurasi, simpan ke private disk), `PresentationLifecycleService` (hapus presentasi + artefak).
